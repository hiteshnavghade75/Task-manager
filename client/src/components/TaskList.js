            ...
            {tasks.length > 0 ? tasks.map((item, index) =>
                <li className="list-group-item p-3" key={index}>
                    ...
                    <span class="edit-delete">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="20" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="20" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
